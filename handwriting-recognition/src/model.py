...
class Model:
    ...
    def setup_ctc(self) -> None:
        ...
        # word beam search decoding (see https://github.com/githubharald/CTCWordBeamSearch)
            ...
            word_chars = open('SimpleHTR-master\\model\\wordCharList.txt').read().splitlines()[0]
            corpus = open('SimpleHTR-master\\data\\corpus.txt').read()
    ...
    def setup_tf(self) -> Tuple[tf.compat.v1.Session, tf.compat.v1.train.Saver]:
        ...
        model_dir = 'handwriting-recognition\\model\\'
    ...
    def save(self) -> None:
        """Save model to file."""
        self.snap_ID += 1
        self.saver.save(self.sess, 'handwriting-recognition\\model\\snapshot-33.index', global_step=self.snap_ID)
